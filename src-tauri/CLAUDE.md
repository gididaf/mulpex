...
| `explainer.rs` (turn extraction, the headless Sonnet child, the worker queue) | [../docs/explainer.md](../docs/explainer.md) — the transcript-flush race, why not `--bare`, no-silent-skip rule |
